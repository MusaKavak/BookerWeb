<template>
    <div id="container">
        <img src="/booker-foreground.svg" alt="Booker">
        <div id="menu">
            <label id="login">
            ...
            <label id="language">
                <svg width="800px" height="800px" viewBox="0 0 24 24" id="meteor-icon-kit__solid-language-alt"
